...
const NavBar = () => {
    ...
    return(
            ...
            <div className="container-fluid">
                ...
                <input className=" me-2 rounded-3 border p-2" type="search" placeholder="Email or Phone" aria-label="Search"/>
                <input className=" me-2 rounded-3 border p-2" placeholder="Password" aria-label="Search"/>
